...
class MovablePositionTest {
    ...
    void shouldSuccessGenerateCrossPosition() {
        ...
        movablePosition.findMovablePosition(ChessBoard.generateChessBoard(), Position.initPosition(5, 3), crossVector,
                true);
    ...
    void shouldSuccessFindKnightRoute() {
        MovablePosition movablePosition = new MovablePosition();
        movablePosition.findMovablePosition(ChessBoard.generateChessBoard(), Position.initPosition(2, 1),
                knightMoveVector, false);
    ...
    void shouldSuccessFindBlackPawnRoute() {
        MovablePosition movablePosition = new MovablePosition();
        movablePosition.findMovablePosition(ChessBoard.generateChessBoard(), Position.initPosition(1, 7),
                blackPawnVector,
                false);
    ...
    void shouldSuccessFindWhitePawnRoute() {
        MovablePosition movablePosition = new MovablePosition();
        movablePosition.findMovablePosition(ChessBoard.generateChessBoard(), Position.initPosition(1, 2),
                whitePawnVector,
                false);
