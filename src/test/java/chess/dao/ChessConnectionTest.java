...
//        DBManager chessConnection = DBManager.getInstance(new ConnectionProperty("localhost:13307", "db_name",
...
//        DBManager chessConnection = DBManager.getInstance(new ConnectionProperty("localhost:13306", "db_nam",
//                "?useSSL=false&serverTimezone=UTC", "root", "root"));
//
//        assertThatThrownBy(() -> chessConnection.getConnection())
//                .isInstanceOf(IllegalArgumentException.class)
...
//        DBManager chessConnection = DBManager.getInstance(new ConnectionProperty("localhost:13306", "db_name",
