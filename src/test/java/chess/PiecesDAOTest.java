...
class PiecesDAOTest {
    ...
    @BeforeEach
    public void setUp() {
        piecesDAO = new PiecesDAO(DBConnector.getConnection());
    }
    ...
    void getPieceSymbolByPositionSymbolTest(String positionSymbol, String expectedPieceSymbol) throws SQLException {
        assertThat(piecesDAO.getPieceSymbolByPositionSymbol(positionSymbol)).isEqualTo(expectedPieceSymbol);
    }
    ...
    void getPieceSymbolByPositionSymbolNullTest(String positionSymbol) throws SQLException {
        assertNull(piecesDAO.getPieceSymbolByPositionSymbol(positionSymbol));
    }
}