...
public class QueenTest {
    ...
    @Test
    void createQueen() {
        Queen queen = new Queen(Color.BLACK, Square.of(File.D, Rank.EIGHT));
    ...
    void movable() {
        Queen queen = new Queen(Color.BLACK, Square.of(File.D, Rank.EIGHT));
        Empty linearSquare = new Empty(Square.of(File.D, Rank.FIVE));
        Empty diagSquare = new Empty(Square.of(File.A, Rank.FIVE));
        assertAll(
