...
class KingTest {
    ...
    private final Piece blackKing = new King(Camp.BLACK);
    ...
    class KingMovableMethodTest {
        private final Piece ally = new Knight(Camp.BLACK);
        ...
        @ParameterizedTest(name = "움직이는 거리가 (1, 1)보다 큰 ({0} / {1})이라면 목적지와 무관하게 움직일 수 없다.")
