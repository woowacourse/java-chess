...
class SquareTest {
    ...
    void getLeftOneNeighbor() {
        ...
        square2 = Square.getLeftOneNeighbor(square1).get();
    ...
    void getLeftOneNeighborNull() {
        ...
        square2 = Square.getLeftOneNeighbor(square1).orElse(null);
    ...
    void getRightOneNeighbor() {
        square1 = new Square(Column.D, Row._5);
        square2 = Square.getRightOneNeighbor(square1).get();
    ...
    void getRightOneNeighborNull() {
        ...
        square2 = Square.getRightOneNeighbor(square1).orElse(null);
        assertThat(square2).isNull();
    }
    ...
    void getUpOneNeighbor() {
        square1 = new Square(Column.D, Row._5);
        square2 = Square.getUpOneNeighbor(square1).get();
    ...
    void getUpOneNeighborNull() {
        ...
        square2 = Square.getUpOneNeighbor(square1).orElse(null);
        assertThat(square2).isNull();
    }
    ...
    void getDownOneNeighbor() {
        square1 = new Square(Column.D, Row._5);
        square2 = Square.getDownOneNeighbor(square1).get();
    ...
    void getDownOneNeighborNull() {
        ...
        square2 = Square.getDownOneNeighbor(square1).orElse(null);
        assertThat(square2).isNull();
    }
    ...
    void getUpperLeftOneNeighbor() {
        square1 = new Square(Column.D, Row._5);
        square2 = Square.getUpperLeftOneNeighbor(square1).get();
    ...
    void getUpperLeftOneNeighborNull() {
        ...
        square2 = Square.getUpperLeftOneNeighbor(square1).orElse(null);
        assertThat(square2).isNull();
    ...
    void getUpperRightOneNeighbor() {
        square1 = new Square(Column.D, Row._5);
        square2 = Square.getUpperRightOneNeighbor(square1).get();
    ...
    void getUpperRightOneNeighborNull() {
        ...
        square2 = Square.getUpperRightOneNeighbor(square1).orElse(null);
        assertThat(square2).isNull();
    ...
    void getLowerLeftOneNeighbor() {
        square1 = new Square(Column.D, Row._5);
        square2 = Square.getLowerLeftOneNeighbor(square1).get();
    ...
    void getLowerLeftOneNeighborNull() {
        ...
        square2 = Square.getLowerLeftOneNeighbor(square1).orElse(null);
        assertThat(square2).isNull();
    ...
    void getLowerRightOneNeighborNull() {
        ...
        square2 = Square.getLowerRightOneNeighbor(square1).orElse(null);
        assertThat(square2).isNull();
