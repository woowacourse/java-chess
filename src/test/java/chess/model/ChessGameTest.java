...
public class ChessGameTest {
    ...
    void move_return_true_when_king_captured() {
        ChessGame chessGame = new ChessGame(new TurnDecider(), new kingCaptureTestInitializer());
    ...
    void when_first_turn_cal_score_then_38() {
        ChessGame chessGame = new ChessGame(new TurnDecider(), new defaultInitializer());
