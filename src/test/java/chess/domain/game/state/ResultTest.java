...
class ResultTest {
    ...
    private AbstractState abstractState = new Result(chessGame);
    ...
    void execute() {
        abstractState = abstractState.execute(new CommandDto("status"));
    ...
    void executeError() {
        assertThatThrownBy(() -> abstractState.execute(new CommandDto("move a2 a3")))
