    ...
    void create_Correctly() {
        ...
        assertThat(squares)
                .contains(
                        ...
                        new Square(new Piece(Role.KING, Team.WHITE), Position.of(3, 0)),
                        new Square(new Piece(Role.QUEEN, Team.WHITE), Position.of(4, 0)),
                        ...
                        new Square(new Piece(Role.KING, Team.BLACK), Position.of(3, 7)),
                        new Square(new Piece(Role.QUEEN, Team.BLACK), Position.of(4, 7)),
