...
class BishopMoveStrategyTest {
    ...
    private final ChessPieceProperty chessPieceProperty =
            new ChessPieceProperty(ChessPieceType.BISHOP, new BishopMoveStrategy());
    ...
    void 목적지가_Bishop이_움직일_수_있는_범위이면_움직인다() {
        chessPiece.move(chessBoard, new Square(Lettering.C, Numbering.ONE), new Square(Lettering.H, Numbering.SIX));
    ...
    void 목적지가_Bishop이_움직일_수_있는_범위가_아니면_움직이지_않는다() {
        chessPiece.move(chessBoard, new Square(Lettering.C, Numbering.ONE), new Square(Lettering.C, Numbering.SIX));
