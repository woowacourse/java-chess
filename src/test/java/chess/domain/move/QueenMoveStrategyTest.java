...
public class QueenMoveStrategyTest {
    ...
    void isMovable_Vertical() {
        board.movePiece(Position.valueOf('d', 2), Position.valueOf('e', 3));

        Position source = Position.valueOf('d', 1);
        Position target = Position.valueOf('d', 4);
    ...
    void isMovableHorizon() {
        board.movePiece(Position.valueOf('e', 1), Position.valueOf('e', 3));

        Position source = Position.valueOf('d', 1);
        Position target = Position.valueOf('e', 1);
    ...
    void isMovable_PositiveDiagonal() {
        board.movePiece(Position.valueOf('e', 2), Position.valueOf('e', 4));

        Position source = Position.valueOf('d', 1);
        Position target = Position.valueOf('e', 2);
    ...
    void isMovable_NegativeDiagonal() {
        board.movePiece(Position.valueOf('c', 2), Position.valueOf('c', 4));

        Position source = Position.valueOf('d', 1);
        Position target = Position.valueOf('c', 2);
