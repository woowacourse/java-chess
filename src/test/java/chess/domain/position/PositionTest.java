...
class PositionTest {
    ...
    void 대각선으로_움직일_수_있는_경로를_알_수_있다() {
        List<Position> path = C_4.findPathWithoutSourceAndTarget(F_7);
        List<Position> reversePath = F_7.findPathWithoutSourceAndTarget(C_4);
    ...
    void 위로_움직일_수_있는_경로를_알_수_있다() {
        List<Position> path = C_4.findPathWithoutSourceAndTarget(C_5);
    ...
    void 대각선_위로_움직일_수_있는_경로를_알_수_있다() {
        List<Position> path = C_4.findPathWithoutSourceAndTarget(D_6);
    ...
    void 앞으로_한두칸_혹은_대각선_한칸_움직일_수_있는_경로를_알_수_있다() {
        List<Position> path = B_1.findPathWithoutSourceAndTarget(B_2);
        List<Position> path2 = B_1.findPathWithoutSourceAndTarget(C_2);
        List<Position> path3 = B_1.findPathWithoutSourceAndTarget(B_3);
    ...
    void 양옆으로_움직일_수_있는_경로를_알_수_있다() {
        List<Position> path = C_4.findPathWithoutSourceAndTarget(F_4);
        List<Position> reversePath = F_4.findPathWithoutSourceAndTarget(C_4);
    ...
    void 룩이_파일로_움직일_수_있는_경로를_알_수_있다() {
        List<Position> path = C_4.findPathWithoutSourceAndTarget(C_7);
        List<Position> reversePath = C_7.findPathWithoutSourceAndTarget(C_4);
