...
public class BoardTest {
    ...
    void moveWrongPiece_Fails() {
        ...
        assertThatThrownBy(() -> board.move(new Position("b8"), new Position("a6"), false))
    ...
    void diagonalStraightMove_Obstacle_Fails() {
        ...
        assertThatThrownBy(() -> board.move(new Position("c1"), new Position("a3"), false))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void diagonalStraightMove_ObstacleAlly_Fails() {
        ...
        assertThatThrownBy(() -> board.move(new Position("c1"), new Position("b2"), false))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void verticalStraightMove_Obstacle_Fails() {
        ...
        assertThatThrownBy(() -> board.move(new Position("a1"), new Position("a3"), false))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("경로에 기물이 존재합니다.");
    }
    ...
    void verticalStraightMove_ObstacleAlly_Fails() {
        ...
        assertThatThrownBy(() -> board.move(new Position("a1"), new Position("a2"), false))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("이동이 불가능한 위치입니다.");
    }
    ...
    void horizontalStraightMove_Obstacle_Fails() {
        ...
        assertThatThrownBy(() -> board.move(new Position("a1"), new Position("c1"), false))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("경로에 기물이 존재합니다.");
    }
    ...
    void horizontalStraightMove_ObstacleAlly_Fails() {
        ...
        assertThatThrownBy(() -> board.move(new Position("a1"), new Position("b1"), false))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("이동이 불가능한 위치입니다.");
    }
}
