...
public class PlayingTest {
    ...
    void diagonalStraightMove_Obstacle_Fails() {
        ...
        assertThatThrownBy(() -> boardState.move(new Position("c1"), new Position("a3")))
    ...
    void diagonalStraightMove_ObstacleAlly_Fails() {
        ...
        assertThatThrownBy(() -> boardState.move(new Position("c1"), new Position("b2")))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void verticalStraightMove_Obstacle_Fails() {
        ...
        assertThatThrownBy(() -> boardState.move(new Position("a1"), new Position("a3")))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("경로에 기물이 존재합니다.");
    }
    ...
    void verticalStraightMove_ObstacleAlly_Fails() {
        ...
        assertThatThrownBy(() -> boardState.move(new Position("a1"), new Position("a2")))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("이동이 불가능한 위치입니다.");
    }
    ...
    void horizontalStraightMove_Obstacle_Fails() {
        ...
        assertThatThrownBy(() -> boardState.move(new Position("a1"), new Position("c1")))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("경로에 기물이 존재합니다.");
    }
    ...
    void horizontalStraightMove_ObstacleAlly_Fails() {
        ...
        assertThatThrownBy(() -> boardState.move(new Position("a1"), new Position("b1")))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("이동이 불가능한 위치입니다.");
    }
}
