...
public class Fixture {
    ...
    static final Arguments NO_ENEMY_ON_END_POINT = Arguments.of(
        ...
        new HashMap<Position, Optional<Piece>>() {{
            ...
            put(Position.of(Row.TWO, Column.B), Optional.empty());
            put(Position.of(Row.THREE, Column.C), Optional.empty());
            put(Position.of(Row.FOUR, Column.D), Optional.of(Piece.of(Type.QUEEN, Side.BLACK)));
    ...
    static final Arguments BLOCKED_PATH = Arguments.of(
        ...
        new HashMap<Position, Optional<Piece>>() {{
            put(Position.of(Row.ONE, Column.A), Optional.of(Piece.of(Type.QUEEN, Side.BLACK)));
            put(Position.of(Row.TWO, Column.B), Optional.of(Piece.of(Type.QUEEN, Side.BLACK)));
            put(Position.of(Row.THREE, Column.C), Optional.empty());
            put(Position.of(Row.FOUR, Column.D), Optional.empty());
        }}, Position.of(Row.ONE, Column.A), Position.of(Row.FOUR, Column.D), true);
