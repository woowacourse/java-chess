...
class PathTest {
    ...
    @Test
    void 단일_칸_이동경로_생성() {
        Path path = Path.ofLimitedPath(Position.of(1, 1), Direction.NORTH, 1);
    ...
    @Test
    void 다중_칸_이동경로_생성() {
        Path path = Path.ofNoLimitPath(Position.of(1, 1), Direction.NORTH);
    ...
    void 크기_제한_다중_이동경로_생성() {
        Path path = Path.ofLimitedPath(Position.of(1, 2), Direction.NORTH, 2);
