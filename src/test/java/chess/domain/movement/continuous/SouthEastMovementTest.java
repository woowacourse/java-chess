...
class SouthEastMovementTest {
    ...
    void isMovableTest() {
        ...
        assertThat(southEastMovement.isMovable(start, end, isAttack)).isTrue();
    }
    ...
    void isMovableTest_false() {
        ...
        assertThat(southEastMovement.isMovable(start, end, isAttack)).isFalse();
    }
    ...
    void findPathTest() {
        ...
        assertThat(southEastMovement.findPath(start, end, isAttack))
