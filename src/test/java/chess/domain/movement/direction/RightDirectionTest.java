...
class RightDirectionTest {
    ...
    void canNotReachWhenNowIsBoundary() {
        RightDirection direction = new RightDirection(8);
        Position source = Position.of(8, 3);
        Position target = Position.of(7, 3);
    ...
    void canNotReachWhenObstacleExist() {
        RightDirection direction = new RightDirection(8);
        Position source = Position.of(6, 3);
        Position target = Position.of(8, 3);
        assertThat(direction.canReach(source, target, List.of(Position.of(7, 3)))).isFalse();
    }
