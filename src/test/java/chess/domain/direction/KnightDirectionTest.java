...
class KnightDirectionTest {
	...
	void north_north_east() {
		...
		assertThat(northNorthEast.confirm(from, to)).isTrue();
	}
	...
	void east_north_east() {
		...
		assertThat(eastNorthEast.confirm(from, to)).isTrue();
	}
	...
	void east_south_east() {
		...
		assertThat(eastSouthEast.confirm(from, to)).isTrue();
	}
	...
	void south_south_east() {
		...
		assertThat(southSouthEast.confirm(from, to)).isTrue();
	}
	...
	void south_south_west() {
		...
		assertThat(southSouthWest.confirm(from, to)).isTrue();
	}
	...
	void west_south_west() {
		...
		assertThat(westSouthWest.confirm(from, to)).isTrue();
	}
	...
	void west_north_west() {
		...
		assertThat(westNorthWest.confirm(from, to)).isTrue();
	}
	...
	void north_north_west() {
		...
		assertThat(northNorthWest.confirm(from, to)).isTrue();
	}
}