...
class BishopTest {
    @Test
    void End로_갈_수_있는_경우() {
        Bishop bishop = Bishop.valueOf(Player.BLACK, Position.getPosition(5, 5));
        ...
        assertThat(bishop.getMovablePath(end)).isEqualTo(path);
    }
    ...
    void End로_갈_수_없는_경우() {
        ...
        assertThrows(NotFoundPathException.class, () -> bishop.getMovablePath(end));
    }
}