...
//import chess.domain.piece.type.pawn.state.MovedPawn;
...
//    @ParameterizedTest(name = "직진 한칸 혹은 대각선으로 한 칸 이동이 가능하다. " +
...
//            "b7,c6",
//    })
//    void 직선으로_한칸_대각선한칸_이동_가능하다(final PiecePosition from, final PiecePosition destination) {
//        // given
...
//            "b7, b5"
//    })
//    void 직선인_경우_두칸부터는_이동할_수_없다(final PiecePosition from, final PiecePosition to) {
//        // given
...
//    }
//
//    @ParameterizedTest(name = "대각선인 경우 두칸부터는 이동할 수 없다. 예를 들어 [{0}] 에서 [{1}]로 이동이 불가능하다")
//    @CsvSource({
//            "c2, e4",
//            "c2, a4",
//            "c4, a1",
