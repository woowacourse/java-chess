...
class BlackPawnTest {
    ...
    public void 이동할_수_있는_모든위치를_반환하는지_테스트() {
        ...
        assertThat(blackPawn.makePossiblePositions(Position.of(START_POSITION), new Board(new HashMap<>())::getCurrentPiece))
                .isEqualTo(positions);
    }
    ...
    public void 첫_번째_이동하는_경우의_모든위치를_반환하는지_테스트() {
        ...
        assertThat(blackPawn.makePossiblePositions(Position.of(DEFAULT_START_POSITION), new Board(new HashMap<>())::getCurrentPiece))
                .isEqualTo(positions);
    }
