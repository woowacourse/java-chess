...
public class QueenTest {
	...
	void is_movable(String to) {
		...
		boolean actual = queen.isMovable(board.getValue(), Coordinate.of("b3"), Coordinate.of(to));
	...
	void is_not_movable() {
		Board board = Board.create();
		Queen queen = new Queen(Symbol.QUEEN, Team.BLACK);
		boolean actual = queen.isMovable(board.getValue(), Coordinate.of("c2"), Coordinate.of("h6"));
