...
class InitialPawnTest {
    ...
    class 흰색_폰_테스트 {
        ...
        @ParameterizedTest(name = "북쪽을 향해 직진 한칸, 두칸 혹은 대각선으로 한 칸 이동이 가능하다. " +
        ...
        void 북쪽으로_한칸_두칸_대각선한칸_이동_가능하다(final PiecePosition from, final PiecePosition destination) {
            // given
        ...
        @Test
        void 직선인_경우_세칸부터는_이동할_수_없다() {
            // given
            final Path path = Path.of(PiecePosition.of("b2"), PiecePosition.of("b5"));
            final InitialPawn initialPawn = new InitialPawn(new WhitePawnMoveStrategy());
    ...
    class 검정색_폰_테스트 {
        ...
        @ParameterizedTest(name = "남쪽을 향해 직진 한칸, 두칸 혹은 대각선으로 한 칸 이동이 가능하다. " +
                "예를 들어 [{0}] 에서 [{1}]로 이동이 가능하다")
        @CsvSource({
                "b7,b6",
                "b7,b5",
        ...
        void 남쪽으로_한칸_두칸_대각선한칸_이동_가능하다(final PiecePosition from, final PiecePosition destination) {
            // given
        ...
        void 직선인_경우_세칸부터는_이동할_수_없다() {
            // given
            final Path path = Path.of(PiecePosition.of("b7"), PiecePosition.of("b4"));
            final InitialPawn initialPawn = new InitialPawn(new BlackPawnMoveStrategy());
