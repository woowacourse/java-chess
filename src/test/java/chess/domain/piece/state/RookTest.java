...
class RookTest {
    ...
    void 룩은_같은_파일의_좌표로_움직일_수_있다() {
        ...
        //when & then
        Assertions.assertThat(rook.findRoute(a1, a3)).containsExactly(SquareCoordinate.of("a2"), SquareCoordinate.of("a3"));
    }
    ...
    void 룩은_같은_랭크의_좌표로_움직일_수_있다() {
        ...
        //when & then
        Assertions.assertThat(rook.findRoute(a1, e1)).containsExactly(SquareCoordinate.of("b1"), SquareCoordinate.of("c1")
