...
class RookTest {
    ...
    ***R****  4
    ...
    void hasFollowedRule(Position target) {
        boolean actual = BLACK_ROOK.hasFollowedRule(D4, target, MovePathFixture.noPieces());

        assertThat(actual).isTrue();
    }

    private static Stream<Arguments> movableTargets() {
        return PositionFixture.movablePositions(List.of(A4, B4, C4, D1, D2, D3, D5, D6, D7, D8, E4, F4, G4, H4));
    }
    ...
    private static Stream<Arguments> immovableTargets() {
        return PositionFixture.immovablePositions(List.of(A4, B4, C4, D1, D2, D3, D5, D6, D7, D8, E4, F4, G4, H4), D4);
    }
}
