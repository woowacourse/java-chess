...
class BlackPawnMovementStrategyTest {
    ...
    public Piece piece(final Color color, final PiecePosition piecePosition) {
        return new Piece(piecePosition, new BlackPawnMovementStrategy(color, Rank.from(7)));
    }

    @Nested
    class 북쪽_이동_불가_테스트 {

        private final PawnMovementStrategy pawnMovement = new BlackPawnMovementStrategy(Color.BLACK, Rank.from(7));
