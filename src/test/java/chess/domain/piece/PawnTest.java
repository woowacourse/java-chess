...
class PawnTest {
    ...
    void whitePawn_시작점_top방향_한칸_두칸_이동_가능하다(String source, String target) {
        ...
        assertDoesNotThrow(
                () -> whitePawn.validateMove(chessBoard.getBoard(), new Position(source), new Position(target)));
    }
    ...
    void whitePawn이_시작점일때_세칸이상_이동한_경우_예외가_발생한다() {
        ChessBoard chessBoard = generateEmptyChessBoard();
        setPiece(chessBoard, "c2", new Pawn(Color.WHITE));
        Pawn pawn = new Pawn(Color.WHITE);

        assertThatThrownBy(() -> pawn.validateMove(chessBoard.getBoard(), new Position("c2"), new Position("c5")))
    ...
    void whitePawn이_시작점에서_이동할때_경로에_기물이_있는_경우_예외가_발생한다() {
        ...
        assertThatThrownBy(() -> whitePawn.validateMove(chessBoard.getBoard(), new Position("a3"), new Position("a4")))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void whitePawn은_top방향으로_한칸_이동_가능하다(String source, String target) {
        ...
        assertDoesNotThrow(() -> pawn.validateMove(chessBoard.getBoard(), new Position(source), new Position(target)));
    }
    ...
    void whitePawn이_두칸_이동한_경우_예외가_발생한다() {
        ...
        assertThatThrownBy(() -> whitePawn.validateMove(chessBoard.getBoard(), new Position("a3"), new Position("a5")))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void whitePawn이_대각선으로_이동할때_기물이_없는_경우_예외가_발생한다() {
        ChessBoard chessBoard = generateEmptyChessBoard();
        setPiece(chessBoard, "c3", new Pawn(Color.WHITE));
        Pawn pawn = new Pawn(Color.WHITE);

        assertThatThrownBy(() -> pawn.validateMove(chessBoard.getBoard(), new Position("c3"), new Position("d4")))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void whitePawn이_대각선으로_이동할때_기물이_같은진영인_경우_예외가_발생한다() {
        ChessBoard chessBoard = generateEmptyChessBoard();
        setPiece(chessBoard, "c3", new Pawn(Color.WHITE));
        setPiece(chessBoard, "d4", new Pawn(Color.WHITE));
        Pawn whitePawn = new Pawn(Color.WHITE);

        assertThatThrownBy(() -> whitePawn.validateMove(chessBoard.getBoard(), new Position("c3"), new Position("d4")))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void blackPawn이_시작점에서_이동할때_경로에_기물이_있는_경우_예외가_발생한다() {
        ...
        setPiece(chessBoard, "d7", new Pawn(Color.BLACK));
        setPiece(chessBoard, "d6", new Pawn(Color.BLACK));
        Pawn pawn = new Pawn(Color.BLACK);

        assertThatThrownBy(() -> pawn.validateMove(chessBoard.getBoard(), new Position("d7"), new Position("d5")))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void blackPawn이_두칸_이동한_경우_예외가_발생한다() {
        ...
        assertThatThrownBy(() -> pawn.validateMove(chessBoard.getBoard(), new Position("d6"), new Position("d4")))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void blackPawn이_대각선으로_이동할때_기물이_없는_경우_예외가_발생한다() {
        ...
        assertThatThrownBy(() -> pawn.validateMove(chessBoard.getBoard(), new Position("d6"), new Position("c5")))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void blackPawn이_대각선으로_이동할때_기물이_같은진영인_경우_예외가_발생한다() {
        ...
        setPiece(chessBoard, "d6", new Pawn(Color.BLACK));
        setPiece(chessBoard, "c5", new Pawn(Color.BLACK));

        assertThatThrownBy(() -> blackPawn.validateMove(chessBoard.getBoard(), new Position("d6"), new Position("c5")))
                .isInstanceOf(IllegalArgumentException.class);
    }
}
