...
public class BlackPawnTest {
    ...
    void 흑색_폰은_7번째_rank에_생성() {
        Pawn2 actual = new BlackPawn(0);
        Pawn2 expected = new BlackPawn(Position.of("a7"));
    ...
    class ForwardOrJumpTest {
        ...
        void 흑색_폰은_한칸_아래로_전진_가능() {
            ...
            Pawn2 expected = new BlackPawn(Position.of("b6"));
        ...
        void 흑색_폰이_위로_후진시_예외발생() {
            Pawn2 pawn = new BlackPawn(Position.of("a4"));
        ...
        void 흑색_폰은_초기화된_위치에서는_두칸_아래로_전진_가능() {
            ...
            Pawn2 expected = new BlackPawn(Position.of("b5"));
        ...
        void 흑색_폰은_초기화된_위치가_아니면_두칸_위로_전진_시도시_예외발생() {
            Pawn2 pawn = new BlackPawn(Position.of("a6"));
    ...
    class AttackTest {
        ...
        void 흑색_폰은_한칸_아래쪽_왼쪽_대각선으로_공격_가능() {
            ...
            Pawn2 expected = new BlackPawn(Position.of("a6"));
        ...
        void 흑색_폰은_한칸_아래쪽_오른쪽_대각선으로_공격_가능() {
            ...
            Pawn2 expected = new BlackPawn(Position.of("c6"));
