...
class BoardTest {
    ...
    static Stream<Arguments> pieceDummy() {
        return Stream.of(
                ...
                // 백의 폰
                Arguments.arguments(File.A, Rank.TWO, Role.PAWN, Side.from(Color.WHITE)),
                Arguments.arguments(File.B, Rank.TWO, Role.PAWN, Side.from(Color.WHITE)),
                Arguments.arguments(File.C, Rank.TWO, Role.PAWN, Side.from(Color.WHITE)),
                Arguments.arguments(File.D, Rank.TWO, Role.PAWN, Side.from(Color.WHITE)),
                Arguments.arguments(File.E, Rank.TWO, Role.PAWN, Side.from(Color.WHITE)),
                Arguments.arguments(File.F, Rank.TWO, Role.PAWN, Side.from(Color.WHITE)),
                Arguments.arguments(File.G, Rank.TWO, Role.PAWN, Side.from(Color.WHITE)),
                Arguments.arguments(File.H, Rank.TWO, Role.PAWN, Side.from(Color.WHITE)),
                // 흑의 폰
                Arguments.arguments(File.A, Rank.SEVEN, Role.PAWN, Side.from(Color.BLACK)),
                Arguments.arguments(File.B, Rank.SEVEN, Role.PAWN, Side.from(Color.BLACK)),
                Arguments.arguments(File.C, Rank.SEVEN, Role.PAWN, Side.from(Color.BLACK)),
                Arguments.arguments(File.D, Rank.SEVEN, Role.PAWN, Side.from(Color.BLACK)),
                Arguments.arguments(File.E, Rank.SEVEN, Role.PAWN, Side.from(Color.BLACK)),
                Arguments.arguments(File.F, Rank.SEVEN, Role.PAWN, Side.from(Color.BLACK)),
                Arguments.arguments(File.G, Rank.SEVEN, Role.PAWN, Side.from(Color.BLACK)),
                Arguments.arguments(File.H, Rank.SEVEN, Role.PAWN, Side.from(Color.BLACK)),
                // 폰을 제외한 흑의 기물
