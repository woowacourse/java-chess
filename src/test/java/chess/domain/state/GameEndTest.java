...
class GameEndTest {
    ...
    void throwExceptionCallMove() {
        assertThatThrownBy(() -> gameEnd.move(ChessBoardPosition.from("e5"), ChessBoardPosition.from("e6")))
    ...
    void winner() {
        GameEnd gameEnd = new GameEnd(new ChessBoard(
            List.of(new King(Color.WHITE, ChessBoardPosition.from("a1")))), Color.WHITE);
