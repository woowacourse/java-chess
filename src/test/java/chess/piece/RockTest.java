...
class RockTest {
    ...
    void moveCheckTest(Position movePosition, boolean expected) {
        ...
        Rook rook = new Rook(Color.BLACK, position);

        boolean canMove = rook.canMove(movePosition, List.of());
    ...
    public static Stream<Arguments> moveCheckTest() {
        return Stream.of(
                ...
                Arguments.of(
                        new Position(Row.THREE, Column.D), true
                ),
                Arguments.of(
                        new Position(Row.THREE, Column.E), true
                ),
                Arguments.of(
                        new Position(Row.THREE, Column.F), true
                ),
                Arguments.of(
                        new Position(Row.THREE, Column.G), true
                ),
                Arguments.of(
                        new Position(Row.THREE, Column.H), true
                ),
                Arguments.of(
                ...
                Arguments.of(
                        new Position(Row.SIX, Column.B), true
                ),
                Arguments.of(
                        new Position(Row.SEVEN, Column.B), true
                ),
                Arguments.of(
                        new Position(Row.EIGHT, Column.B), true
                ),
                Arguments.of(
    ...
    void canMoveTest2(){
        ...
        Rook rook = new Rook(Color.BLACK, position);
        Position toPosition = new Position(Row.THREE, Column.D);
        Pawn pawn = new Pawn(Color.BLACK,toPosition);
        boolean canMove = rook.canMove(toPosition, List.of(pawn));
