...
public class BishopTest {
	...
	void bishopPathTest(Position start, Position destination, List<Position> trace) {
		...
		List<Position> actual = bishop.movePathExceptSourceAndTarget(start, destination);
	...
	void invalidMovementTest() {
		Bishop bishop = new Bishop(BLACK);
		assertThatThrownBy(() -> bishop.movePathExceptSourceAndTarget(Position.of("a1"), Position.of("b1")))
