...
public class PointFixture {
    ...
    public static final Point A5 = Point.of(File.A, Rank.FIVE);
    public static final Point A7 = Point.of(File.A, Rank.SEVEN);
    public static final Point A8 = Point.of(File.A, Rank.EIGHT);
    public static final Point B1 = Point.of(File.B, Rank.ONE);
    public static final Point B2 = Point.of(File.B, Rank.TWO);
    public static final Point B3 = Point.of(File.B, Rank.THREE);
    public static final Point B5 = Point.of(File.B, Rank.FIVE);
    public static final Point B6 = Point.of(File.B, Rank.SIX);
    public static final Point B8 = Point.of(File.B, Rank.EIGHT);
    public static final Point C3 = Point.of(File.C, Rank.THREE);
    public static final Point C7 = Point.of(File.C, Rank.SEVEN);
    public static final Point C8 = Point.of(File.C, Rank.EIGHT);
    public static final Point D7 = Point.of(File.D, Rank.SEVEN);
    public static final Point E1 = Point.of(File.E, Rank.ONE);
    public static final Point E2 = Point.of(File.E, Rank.TWO);
    public static final Point E6 = Point.of(File.E, Rank.SIX);
    public static final Point H4 = Point.of(File.H, Rank.FOUR);
    public static final Point F1 = Point.of(File.F, Rank.ONE);
    public static final Point F2 = Point.of(File.F, Rank.TWO);
    public static final Point F3 = Point.of(File.F, Rank.THREE);
    public static final Point F4 = Point.of(File.F, Rank.FOUR);
    ...
    public static final Point G2 = Point.of(File.G, Rank.TWO);
    public static final Point G4 = Point.of(File.G, Rank.FOUR);
    public static final Point H1 = Point.of(File.H, Rank.ONE);
    public static final Point H3 = Point.of(File.H, Rank.THREE);
