...
class BoardTest {
    ...
    void Should_ThrowException_When_SourceIsSameWithTarget() {
        Assertions.assertThatThrownBy(() -> board.move(A1, A1, Team.WHITE))
    ...
    void Should_CantAttack_When_SameTeam() {
        Assertions.assertThatThrownBy(() -> board.move(A1, A2, Team.WHITE))
            .isExactlyInstanceOf(IllegalArgumentException.class)
    ...
    void Should_False_When_RouteBlockedByPiece() {
        Assertions.assertThatThrownBy(() -> board.move(A1, A8, Team.WHITE))
            .isExactlyInstanceOf(IllegalArgumentException.class)
