...
public class PositionTest {
    ...
    void getXPointDirectionValueToTest(String source, String target, int expected) {
        int result = PositionFactory.of(source).getXPointDirectionValueTo(PositionFactory.of(target));
    ...
    void getYPointDirectionValueToTest(String source, String target, int expected) {
        int result = PositionFactory.of(source).getYPointDirectionValueTo(PositionFactory.of(target));
        Assertions.assertThat(result).isEqualTo(expected);
    }
}
