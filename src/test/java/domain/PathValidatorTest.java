...
class PathValidatorTest {
    ...
    public void testValidate() {
        //given
        final Square start = new Square(Queen.makeBlack());
    ...
    public void testValidateWhenEnemyInDestination() {
        //given
        final Square start = new Square(Queen.makeBlack());
        final List<Square> paths = List.of(Square.empty(), new Square(Queen.makeWhite()));
    ...
    public void testNotValidate() {
        //given
        final Square start = new Square(Queen.makeWhite());
        final List<Square> paths = List.of(Square.empty(), new Square(Queen.makeBlack()), Square.empty());
    ...
    public void testNotValidateWhenDestinationBlocked() {
        //given
        final Square start = new Square(Queen.makeBlack());
        final List<Square> paths = List.of(Square.empty(), new Square(Queen.makeBlack()));
