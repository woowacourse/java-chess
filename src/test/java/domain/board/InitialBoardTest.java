...
class InitialBoardTest {
	...
	@DisplayName("체스 폰의 초기 위치 테스트")
	@ParameterizedTest(name = "{index} - column: {0} Piece: Pawn")
	...
	@DisplayName("체스 특별한 기물들 초기 위치 테스트")
	@ParameterizedTest(name = "{index} -  column: {0} Piece: {1}")
