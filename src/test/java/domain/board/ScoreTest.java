...
public class ScoreTest {
	...
	void getScore_InitialBoard_IsBlack38AndWhit38() {
		Map<Team, Double> allScore = Score.calculateScore(BoardFactory.create().getRanks(), Team.values());
	...
	void getScore_Black1RookAndWhite2Rook_Black5White10() {
		Map<Team, Double> allScore = Score.calculateScore(new RookBoard().create().getRanks(), Team.values());
