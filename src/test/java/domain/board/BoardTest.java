...
public class BoardTest {
	...
	void move_InvalidPosition_ExceptionThrown(MoveInfo moveInfo) {
		assertThatThrownBy(() -> boardGame.move(moveInfo, Team.WHITE))
	...
	void move_InvalidTurn_ExceptionThrown(MoveInfo moveInfo) {
		assertThatThrownBy(() -> boardGame.move(moveInfo, Team.BLACK))
