...
class KnightMovementValidationTest {
    @ParameterizedTest
    @EnumSource(value = Direction.class, names = {"KNIGHT_UP_LEFT", "KNIGHT_UP_RIGHT", "KNIGHT_LEFT_UP",
            "KNIGHT_LEFT_DOWN",
    ...
    @EnumSource(value = Direction.class, names = {"KNIGHT_UP_LEFT", "KNIGHT_UP_RIGHT", "KNIGHT_LEFT_UP",
            "KNIGHT_LEFT_DOWN",
            "KNIGHT_DOWN_LEFT", "KNIGHT_DOWN_RIGHT", "KNIGHT_RIGHT_UP",
            "KNIGHT_RIGHT_DOWN"}, mode = EnumSource.Mode.EXCLUDE)
