...
class QueenTest {
    ...
    void can_move_up_right() {
        final var sut = new Queen(new Point(C, Rank.FOUR), Color.BLACK);
    ...
    void can_move_down_left() {
        ...
        final var result = sut.canMove(new Point(File.B, THREE));
    ...
    void can_move_up_left() {
        final var sut = new Queen(new Point(C, TWO), Color.BLACK);
    ...
    void can_move_down_right() {
        final var sut = new Queen(new Point(F, Rank.FOUR), Color.BLACK);
    ...
    void can_move_down() {
        ...
        final var result = sut.canMove(new Point(C, Rank.ONE));
    ...
    void can_move_up() {
        ...
        final var result = sut.canMove(new Point(C, Rank.EIGHT));
