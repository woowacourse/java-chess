...
class BishopTest {
    ...
    void check_diagonal_if_empty_piece(String endPosition) {
        ...
        assertThat(bishop.canMove(board.getPieceMap(), Position.of("c5"), Position.of(endPosition))).isTrue();
    }
    ...
    void check_diagonal_if_enemy_piece() {
        ...
        assertThat(bishop.canMove(board.getPieceMap(), Position.of("c5"), Position.of("d4"))).isTrue();
    }
    ...
    void check_diagonal_false_test(String endPosition) {
        ...
        assertThat(bishop.canMove(board.getPieceMap(), Position.of("c5"), Position.of(endPosition))).isFalse();
    }
    ...
    void cant_move_bishop_if_piece_exist(String from, String middle, String name, boolean color, String to) {
        ...
        assertThat(bishop.canMove(board.getPieceMap(), Position.of(from), Position.of(to))).isFalse();
    }
    ...
    void cant_move_bishop_if_same_color_piece_exist() {
        ...
        assertThat(bishop.canMove(board.getPieceMap(), Position.of("e5"), Position.of("g3"))).isFalse();
    }
}