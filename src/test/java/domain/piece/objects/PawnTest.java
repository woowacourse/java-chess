...
class PawnTest {
    ...
    void pawn_move_forward_if_empty_piece() {
        ...
        assertThat(pawn.canMove(board.getPieceMap(), Position.of("a7"), Position.of("a6"))).isTrue();
    }
    ...
    void pawn_move_forward_if_same_color_piece() {
        ...
        assertThat(pawn.canMove(board.getPieceMap(), Position.of("a7"), Position.of("a6"))).isFalse();
    }
    ...
    void pawn_move_forward_two_step_if_empty_piece() {
        ...
        assertThat(pawn.canMove(board.getPieceMap(), Position.of("a7"), Position.of("a5"))).isTrue();
    }
    ...
    void pawn_cant_move_forward_two_step_if_piece() {
        ...
        assertThat(pawn.canMove(board.getPieceMap(), Position.of("a7"), Position.of("a5"))).isFalse();
    }
    ...
    void pawn_cant_move_forward_two_step_if_not_initial_position() {
        ...
        assertThat(pawn.canMove(board.getPieceMap(), Position.of("a6"), Position.of("a4"))).isFalse();
    }
    ...
    void catch_enemy_if_enemy_exist_at_diagonal() {
        ...
        assertThat(pawn.canMove(board.getPieceMap(), Position.of("c6"), Position.of("d5"))).isTrue();
    }
    ...
    void catch_enemy_if_enemy_not_exist_at_diagonal() {
        ...
        assertThat(pawn.canMove(board.getPieceMap(), Position.of("c6"), Position.of("b5"))).isFalse();
    }
}