...
public class PawnTest {
    ...
    void canMove_WhiteFirstMove_True() {
        ...
        Position source = PositionGenerator.generate(File.D, Rank.TWO);
        Position target1 = PositionGenerator.generate(File.D, Rank.THREE);
        Position target2 = PositionGenerator.generate(File.D, Rank.FOUR);
    ...
    void canMove_WhiteNotFirstMove_True() {
        Piece piece = new Pawn(Color.WHITE);
        Position source = PositionGenerator.generate(File.D, Rank.FIVE);
    ...
    void canMove_WhiteNotFirstMove_False() {
        Piece piece = new Pawn(Color.WHITE);
        Position source = PositionGenerator.generate(File.D, Rank.FIVE);
        Position target = PositionGenerator.generate(File.D, Rank.SEVEN);
    ...
    void canMove_BlackFirstMove_True() {
        ...
        Position source = PositionGenerator.generate(File.D, Rank.SEVEN);
        Position target1 = PositionGenerator.generate(File.D, Rank.SIX);
        Position target2 = PositionGenerator.generate(File.D, Rank.FIVE);
    ...
    void canMove_BlackNotFirstMove_True() {
        Piece piece = new Pawn(Color.BLACK);
        Position source = PositionGenerator.generate(File.D, Rank.THREE);
        Position target = PositionGenerator.generate(File.D, Rank.TWO);
    ...
    void canAttack_White_True() {
        Piece piece = new Pawn(Color.WHITE);
        Position source = PositionGenerator.generate(File.D, Rank.TWO);
        Position target1 = PositionGenerator.generate(File.E, Rank.THREE);
        Position target2 = PositionGenerator.generate(File.C, Rank.THREE);
    ...
    void canAttack_White_False() {
        Piece piece = new Pawn(Color.WHITE);
        Position source = PositionGenerator.generate(File.D, Rank.TWO);
        Position target1 = PositionGenerator.generate(File.E, Rank.FOUR);
        Position target2 = PositionGenerator.generate(File.C, Rank.FOUR);
    ...
    void canAttack_Black_True() {
        Piece piece = new Pawn(Color.BLACK);
        Position source = PositionGenerator.generate(File.D, Rank.SEVEN);
        Position target1 = PositionGenerator.generate(File.E, Rank.SIX);
        Position target2 = PositionGenerator.generate(File.C, Rank.SIX);
    ...
    void canAttack_Black_False() {
        Piece piece = new Pawn(Color.BLACK);
        Position source = PositionGenerator.generate(File.D, Rank.SEVEN);
        Position target1 = PositionGenerator.generate(File.E, Rank.FIVE);
        Position target2 = PositionGenerator.generate(File.C, Rank.FIVE);
