...
class PawnTest {
    ...
    @Test
    @DisplayName("블랙 폰은 위로 한 칸 이동할 수 있다")
    ...
    @Test
    @DisplayName("블랙 폰은 위로 두 칸 이동할 수 있다")
    ...
    @Test
    @DisplayName("블랙 폰은 위로 세 칸 이동할 수 없다")
    ...
    @Test
    @DisplayName("블랙 폰은 아래로 한 칸 이동할 수 없다")
    ...
    @Test
    @DisplayName("화이트 폰은 아래로 한 칸 이동할 수 있다")
    ...
    @Test
    @DisplayName("화이트 폰은 아래로 두 칸 이동할 수 있다")
    ...
    @Test
    @DisplayName("화이트 폰은 아래로 세 칸 이동할 수 없다")
    ...
    @Test
    @DisplayName("화이트 폰은 위로 한 칸 이동할 수 없다")
