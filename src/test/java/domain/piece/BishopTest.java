...
class BishopTest {
    ...
    void shouldReturnFalseWhenBishopDirectionIsNotDiagonal() {
        Bishop whiteBishop = new Bishop(Side.BLACK);
    ...
    void shouldReturnFalseWhenBishopDirectionIsDiagonalButTargetPieceIsSameSide() {
        ...
        boolean movable = blackBishop.isMovable(new Pawn(Side.BLACK), Position.of("c", "2"), Position.of("e", "4"));
    ...
    void shouldReturnTrueWhenBishopDirectionIsDiagonalAndTargetPieceIsOpponentSide() {
        Bishop whiteBishop = new Bishop(Side.WHITE);
        boolean movable = whiteBishop.isMovable(new Pawn(Side.BLACK), Position.of("c", "2"), Position.of("e", "4"));
    ...
    void blackBishopCategoryTest() {
        assertThat(new Bishop(Side.BLACK).getCategory()).isEqualTo(PieceCategory.BLACK_BISHOP);
    }

    @DisplayName("white Bishop의 경우 white bishop카테고리를 반환한다.")
    @Test
    void whiteBishopCategoryTest() {
        assertThat(new Bishop(Side.WHITE).getCategory()).isEqualTo(PieceCategory.WHITE_BISHOP);
    }
}