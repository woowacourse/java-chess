...
public class ChessBoardGeneratorTest {
    ...
    void checkPositionWhitePawn(File file) {
        Map<Position, Piece> board = ChessBoardGenerator.generate();
        Piece piece = board.get(Position.of(file, Rank.TWO));
    ...
    void checkPositionBlackRook() {
        Map<Position, Piece> board = ChessBoardGenerator.generate();
        Piece leftRook = board.get(Position.of(File.A, Rank.EIGHT));
        Piece rightRook = board.get(Position.of(File.H, Rank.EIGHT));
    ...
    void checkPositionWhiteRook() {
        Map<Position, Piece> board = ChessBoardGenerator.generate();
        Piece leftRook = board.get(Position.of(File.A, Rank.ONE));
        Piece rightRook = board.get(Position.of(File.H, Rank.ONE));
    ...
    void checkPositionBlackKnight() {
        Map<Position, Piece> board = ChessBoardGenerator.generate();
        Piece leftKnight = board.get(Position.of(File.B, Rank.EIGHT));
        Piece rightKnight = board.get(Position.of(File.G, Rank.EIGHT));
    ...
    void checkPositionWhiteKnight() {
        Map<Position, Piece> board = ChessBoardGenerator.generate();
        Piece leftKnight = board.get(Position.of(File.B, Rank.ONE));
        Piece rightKnight = board.get(Position.of(File.G, Rank.ONE));
    ...
    void checkPositionBlackBishop() {
        Map<Position, Piece> board = ChessBoardGenerator.generate();
        Piece leftBishop = board.get(Position.of(File.C, Rank.EIGHT));
        Piece rightBishop = board.get(Position.of(File.F, Rank.EIGHT));
    ...
    void checkPositionWhiteBishop() {
        Map<Position, Piece> board = ChessBoardGenerator.generate();
        Piece leftBishop = board.get(Position.of(File.C, Rank.ONE));
        Piece rightBishop = board.get(Position.of(File.F, Rank.ONE));
    ...
    void checkPositionBlackQueen() {
        Map<Position, Piece> board = ChessBoardGenerator.generate();
        Piece piece = board.get(Position.of(File.D, Rank.EIGHT));
    ...
    void checkPositionWhiteQueen() {
        Map<Position, Piece> board = ChessBoardGenerator.generate();
        Piece piece = board.get(Position.of(File.D, Rank.ONE));
    ...
    void checkPositionBlackKing() {
        Map<Position, Piece> board = ChessBoardGenerator.generate();
        Piece piece = board.get(Position.of(File.E, Rank.EIGHT));
    ...
    void checkPositionWhiteKing() {
        Map<Position, Piece> board = ChessBoardGenerator.generate();
        Piece piece = board.get(Position.of(File.E, Rank.ONE));
