...
public enum PawnStrategy {
    ...
    PawnStrategy(int rowDifference, int columnDifference, List<Integer> direction, boolean isBlack) {
    ...
    public static PawnStrategy getMoveStrategy(int xDifference, int yDifference) {
