...
public class OutputView {
    ...
    public static void printGameScores(Map<Side, Double> scores) {
    ...
    public static void printSide(Side side) {
    ...
    public static void printGameSaveMessage() {
        System.out.println("게임을 저장합니다.");
    }

    public static void printKingDeadMessage(Side side) {
        System.out.println(side + "진영의 King이 죽었습니다.");
    }

    public static void printGameRooms(List<Long> rooms) {
        System.out.println("게임 방 목록");
        rooms.forEach((room) -> System.out.println(room + "번 방을 입장하려면 load " + room + "을 입력하세요"));
    }

    public static void printGameCreateMessage() {
