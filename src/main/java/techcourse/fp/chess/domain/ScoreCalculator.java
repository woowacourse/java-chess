...
public class ScoreCalculator {
    ...
    public double calculate(Map<Position, Piece> board, final Color color) {
        return getSumOfDefaultScore(board, color) - getCountOfMultiPawn(board, color) * SCORE_OF_MULTI_PAWN;
    }

    private double getSumOfDefaultScore(final Map<Position, Piece> board, final Color color) {
    ...
    private double getCountOfMultiPawn(final Map<Position, Piece> board, final Color color) {
    ...
    private long getCountOfPawnByFile(final Map<Position, Piece> board, final Color color, final File file) {
