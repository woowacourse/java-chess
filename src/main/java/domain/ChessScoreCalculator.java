...
public class ChessScoreCalculator {
    ...
    public ChessScoreCalculator(final Map<Team, Score> teamScores) {
        this.teamScores = teamScores;
    }

    public static ChessScoreCalculator from(final Map<Square, Piece> pieceSquares) {
        final Score whiteScore = sumTotalScore(pieceSquares, Team.WHITE);
        final Score blackScore = sumTotalScore(pieceSquares, Team.BLACK);

        return new ChessScoreCalculator(Map.of(Team.WHITE, whiteScore, Team.BLACK, blackScore));
    }
    ...
    public Score score(final Team team) {
