...
public enum InitialPieceRepository {
    ...
    BLACK_PAWN_1(Pawn::of, Player.BLACK, Position.of("A7")),
    BLACK_PAWN_2(Pawn::of, Player.BLACK, Position.of("B7")),
    BLACK_PAWN_3(Pawn::of, Player.BLACK, Position.of("C7")),
    BLACK_PAWN_4(Pawn::of, Player.BLACK, Position.of("D7")),
    BLACK_PAWN_5(Pawn::of, Player.BLACK, Position.of("E7")),
    BLACK_PAWN_6(Pawn::of, Player.BLACK, Position.of("F7")),
    BLACK_PAWN_7(Pawn::of, Player.BLACK, Position.of("G7")),
    BLACK_PAWN_8(Pawn::of, Player.BLACK, Position.of("H7")),
    ...
    WHITE_PAWN_1(Pawn::of, Player.WHITE, Position.of("A2")),
    WHITE_PAWN_2(Pawn::of, Player.WHITE, Position.of("B2")),
    WHITE_PAWN_3(Pawn::of, Player.WHITE, Position.of("C2")),
    WHITE_PAWN_4(Pawn::of, Player.WHITE, Position.of("D2")),
    WHITE_PAWN_5(Pawn::of, Player.WHITE, Position.of("E2")),
    WHITE_PAWN_6(Pawn::of, Player.WHITE, Position.of("F2")),
    WHITE_PAWN_7(Pawn::of, Player.WHITE, Position.of("G2")),
    WHITE_PAWN_8(Pawn::of, Player.WHITE, Position.of("H2")),
