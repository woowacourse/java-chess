...
public class BoardFactory {
    ...
    private static void placePawns(final Map<Position, Piece> pieces) {
    ...
    private static void placeRooks(final Map<Position, Piece> pieces) {
    ...
    private static void placeKnights(final Map<Position, Piece> pieces) {
    ...
    private static void placeBishops(final Map<Position, Piece> pieces) {
    ...
    private static void placeQueens(final Map<Position, Piece> pieces) {
    ...
    private static void placeKings(final Map<Position, Piece> pieces) {
