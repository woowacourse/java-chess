...
public enum InitialPiece {
    ...
    WHITE_KING(List.of(4), TeamColor.WHITE.startingRank(), new King(TeamColor.WHITE)),
    WHITE_QUEEN(List.of(5), TeamColor.WHITE.startingRank(), new Queen(TeamColor.WHITE)),
    ...
    BLACK_KING(List.of(4), TeamColor.BLACK.startingRank(), new King(TeamColor.BLACK)),
    BLACK_QUEEN(List.of(5), TeamColor.BLACK.startingRank(), new Queen(TeamColor.BLACK)),
