...
public class WhitePawnMoveRule implements MoveRule {
    public static final int ONE_SQUARE = 1;
    private static WhitePawnMoveRule instance;
    private final Direction direction = Direction.PLUS;

    private WhitePawnMoveRule() {
    }

    public static WhitePawnMoveRule getInstance() {
        if (instance == null) {
            instance = new WhitePawnMoveRule();
        }
        return instance;
    }
