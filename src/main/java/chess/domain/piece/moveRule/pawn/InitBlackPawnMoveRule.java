...
public class InitBlackPawnMoveRule implements MoveRule {
    public static final int TWO_SQUARE = 2;
    public static final int ONE_SQUARE = 1;
    private static InitBlackPawnMoveRule instance;
    private final Direction direction = Direction.MINUS;

    private InitBlackPawnMoveRule() {
    }

    public static InitBlackPawnMoveRule getInstance() {
        if (instance == null) {
            instance = new InitBlackPawnMoveRule();
        }
        return instance;
    }
