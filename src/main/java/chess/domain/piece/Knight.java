...
public class Knight extends Piece {
    private static final List<Direction> POSSIBLE_DIRECTIONS = List.of(Direction.KNIGHT_UP_RIGHT,
            Direction.KNIGHT_RIGHT_UP,
            Direction.KNIGHT_RIGHT_DOWN, Direction.KNIGHT_DOWN_RIGHT, Direction.KNIGHT_DOWN_LEFT,
