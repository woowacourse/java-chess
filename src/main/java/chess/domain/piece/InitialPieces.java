...
public enum InitialPieces {
    ...
    BLACK_PAWN1(new Pawn(Color.BLACK), new Position(PositionX.A, PositionY.RANK_7)),
    BLACK_PAWN2(new Pawn(Color.BLACK), new Position(PositionX.B, PositionY.RANK_7)),
    BLACK_PAWN3(new Pawn(Color.BLACK), new Position(PositionX.C, PositionY.RANK_7)),
    BLACK_PAWN4(new Pawn(Color.BLACK), new Position(PositionX.D, PositionY.RANK_7)),
    BLACK_PAWN5(new Pawn(Color.BLACK), new Position(PositionX.E, PositionY.RANK_7)),
    BLACK_PAWN6(new Pawn(Color.BLACK), new Position(PositionX.F, PositionY.RANK_7)),
    BLACK_PAWN7(new Pawn(Color.BLACK), new Position(PositionX.G, PositionY.RANK_7)),
    BLACK_PAWN8(new Pawn(Color.BLACK), new Position(PositionX.H, PositionY.RANK_7)),

    BLACK_ROOK1(new Rook(Color.BLACK), new Position(PositionX.A, PositionY.RANK_8)),
    BLACK_KNIGHT1(new Knight(Color.BLACK), new Position(PositionX.B, PositionY.RANK_8)),
    BLACK_BISHOP1(new Bishop(Color.BLACK), new Position(PositionX.C, PositionY.RANK_8)),
    BLACK_QUEEN(new Queen(Color.BLACK), new Position(PositionX.D, PositionY.RANK_8)),
    BLACK_KING(new King(Color.BLACK), new Position(PositionX.E, PositionY.RANK_8)),
    BLACK_BISHOP2(new Bishop(Color.BLACK), new Position(PositionX.F, PositionY.RANK_8)),
    BLACK_KNIGHT2(new Knight(Color.BLACK), new Position(PositionX.G, PositionY.RANK_8)),
    BLACK_ROOK2(new Rook(Color.BLACK), new Position(PositionX.H, PositionY.RANK_8));
