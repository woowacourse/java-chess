...
public enum PieceInitializer {
    ...
    H1(PieceType.ROOK, PositionFactory.of("h1"), new UnblockedMovable(Directions.LINEAR)),
    ...
    A8(PieceType.ROOK, PositionFactory.of("a8"), new UnblockedMovable(Directions.LINEAR)),
