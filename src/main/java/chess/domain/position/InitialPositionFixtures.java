...
public class InitialPositionFixtures {
    ...
    public static final Position WHITE_QUEEN_POSITION = new Position(4, 1);
    public static final Position BLACK_QUEEN_POSITION = new Position(4, 8);
    public static final Position WHITE_KNIGHT_LEFT_POSITION = new Position(2, 1);
    ...
    public static final Position BLACK_ROOK_RIGHT_POSITION = new Position(8, 8);
}
