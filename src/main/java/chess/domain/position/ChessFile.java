...
public enum ChessFile {
	...
	ChessFile(final String chessFile, final int fileValue) {
		this.chessFile = chessFile;
		this.fileValue = fileValue;
	}

	public static ChessFile from(final char chessFile) {
	...
	public static ChessFile from(final String chessFile) {
		return Arrays.stream(values())
	...
	public static ChessFile from(final int fileValue) {
		return Arrays.stream(values())
	...
	ChessFile move(final int movingFileValue) {
		return from(this.fileValue + movingFileValue);
	}

	public int gapTo(final ChessFile targetChessFile) {
