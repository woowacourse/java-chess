...
public enum PieceOutputText {
    ...
    Pawn("P", piece -> piece.isSameType(chess.console.domain.piece.Pawn.class)),
    Bishop("B", piece -> piece.isSameType(chess.console.domain.piece.Bishop.class)),
    Knight("N", piece -> piece.isSameType(chess.console.domain.piece.Knight.class)),
    ROOK("R", piece -> piece.isSameType(chess.console.domain.piece.Rook.class)),
    Queen("Q", piece -> piece.isSameType(chess.console.domain.piece.Queen.class)),
    KING("K", piece -> piece.isSameType(chess.console.domain.piece.King.class)),
    ;
