...
public class ChessBoardFactory {
    ...
    private void addQueens(final HashMap<Position, Piece> pieces) {
        pieces.put(Position.of(Rank.EIGHT, File.D), Queen.getQueenOf(Side.BLACK));
        pieces.put(Position.of(Rank.ONE, File.D), Queen.getQueenOf(Side.WHITE));
    }

    private void addKings(final HashMap<Position, Piece> pieces) {
        pieces.put(Position.of(Rank.EIGHT, File.E), King.getKingOf(Side.BLACK));
        pieces.put(Position.of(Rank.ONE, File.E), King.getKingOf(Side.WHITE));
    }
