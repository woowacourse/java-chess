...
public enum ChessCommand {
    ...
    public static ChessCommand from(final String inputCommand) {
    ...
    public static void validatePlayingCommand(final List<String> inputCommand) {
    ...
    public static void validateStartCommand(final List<String> inputCommand) {
        ChessCommand chessCommand = from(inputCommand.get(COMMAND_INDEX));
