...
public class OutputView {
    ...
    private static final String MESSAGE_MOVE_COMMAND =
    ...
    private static final String FORMAT_WINNER_AND_SCORE =
            "%s가 %.1f 점 차이로 이기고 있습니다." + LINE_SEPARATOR + LINE_SEPARATOR;
    ...
    private static final String ERROR_BLACK_IS_EQUAL_TO_WHITE =
            "BLACK과 WHITE의 점수가 같을 경우 이 메소드를 사용해서는 안됩니다.";
    ...
    public static void printStatusWithRunningMessage(double blackScore, double whiteScore) {
        ...
        System.out.printf(FORMAT_WINNER_AND_SCORE, winner(blackScore, whiteScore),
                Math.abs(blackScore - whiteScore));
    }
