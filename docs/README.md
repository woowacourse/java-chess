...
- [ ] 게임 종료 조건 추가
  - [ ] King 이 잡혔을 때에 게임을 종료한다.
  - [ ] King 이 잡힌 진영이 게임에서 진다.
- [ ] 점수 계산 기능 추가
  - [ ] 현재 남아 있는 말들로 점수를 구한다.
    - [ ] Queen 9점, Rook 5점, Bishop 3점, Knight 2.5점 King 0점으로 계산한다.
    - [ ] Pawn 은 각 1점이지만 같은 세로줄에 있는 경우 해당 세로줄의 모든 Pawn 들은 0.5점으로 계산한다.
    - [ ] 한 번에 한 쪽의 점수를 계산해야 한다.
- [ ] 명령어 종류 추가
