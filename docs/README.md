...
- [ ] 체스판은 source 좌표와 target 좌표를 받아서 기물을 움직일 수 있다.
    - [ ] 갈 수 없는 곳이면 예외를 발생한다.
        - [ ] source 좌표에 기물이 없으면 예외를 발생한다.
        - [ ] 체스판의 범위를 벗어나면 갈 수 없다.
        - [ ] target 좌표에 같은 팀이 있다면, 이동할 수 없다.
        - [ ] target 좌표가 선택된 기물이 이동할 수 없는 곳이면 갈 수 없다.
...
- [ ] 기물은 움직일 수 있는 위치를 반환할 수 있다.
    ...
    - [ ] 폰은 적진 방향으로 1칸 움직일 수 있다.
    - [ ] 폰은 초기 위치에 있을 경우, 적진 방향으로 2칸 움직일 수 있다.
    - [ ] 폰은 적진 방향 대각선 위치에 적 기물이 존재한다면, 움직일 수 있다.
